...
struct drm_mode_create_dumb {
	...
	*/
	...
	map_src = mmap64(0, bo_src.size, PROT_READ | PROT_WRITE, MAP_SHARED, bo_src.fd, arg_map_src.offset);
	...
	map_dst = mmap64(0, bo_dst.size, PROT_READ | PROT_WRITE, MAP_SHARED, bo_dst.fd, arg_map_dst.offset);
